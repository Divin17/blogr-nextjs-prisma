...
async function publishPost(id: number): Promise<void> {
   await fetch(`https://ishimwe-divin-blogr-nextjs-prisma.vercel.app/api/publish/${id}`, {
      method: 'PUT',
   });
   await Router.push('/');
}
async function deletePost(id: number): Promise<void> {
   await fetch(`https://ishimwe-divin-blogr-nextjs-prisma.vercel.app/api/post/${id}`, {
      method: 'DELETE',
   });
   Router.push('/');
}
